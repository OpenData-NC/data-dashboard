...
#these dictionaries are used to customize sql queries and parts of search.py based on what the user is querying
   
#dictionaries that map params passed to the api to appropriate parts of the sql query
all_search_items = {
