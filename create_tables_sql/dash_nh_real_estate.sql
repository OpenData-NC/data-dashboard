...
--
-- Table structure for table `dash_nh_real_estate`
--

DROP TABLE IF EXISTS `dash_nh_real_estate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dash_nh_real_estate` (
  `pid` varchar(30) NOT NULL,
  `tax_dist` char(2) DEFAULT NULL,
  `property_type` varchar(50) DEFAULT NULL,
  `land_use` varchar(50) DEFAULT NULL,
  `legal_description` mediumtext,
  ...
  `zip` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`pid`,`sale_date`,`instrument`,`seller`,`buyer`)
