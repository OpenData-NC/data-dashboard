...
--
-- Table structure for table `nc_voters_new`
--

DROP TABLE IF EXISTS `nc_voters_new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nc_voters_new` (
  ...
  `full_phone_number` bigint(20) unsigned DEFAULT '0',
  ...
  `drivers_lic` char(10) DEFAULT NULL,
  ...
  KEY `party_cd` (`county_desc`),
  KEY `party_cd_2` (`party_cd`),
  KEY `voter_status_desc` (`voter_status_desc`),
  ...
  KEY `county_desc_2` (`county_desc`,`last_name`,`first_name`)
