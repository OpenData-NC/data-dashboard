...
CREATE TABLE `arrests` (
  ...
  KEY `lat` (`lat`,`lon`),
  KEY `charge` (`charge`),
  KEY `date_occurred` (`date_occurred`),
  KEY `county` (`county`),
  KEY `county_2` (`county`,`name`),
  KEY `county_3` (`county`,`date_occurred`),
  KEY `county_4` (`county`,`address`)
...
-- Dump completed on 2015-08-14 12:15:56
